...
MINIO_ENABLED=false
MINIO_ACCESS_KEY=82MPTDCECMCE52ZT59R5
MINIO_SECRET_KEY=4mw7HNvzBvNjVOAgwPauTYcO39WNHSH8+Z7hIG8c
...
if [ -n "${MINIO_ENABLED}" ]
then
  export MINIO_ACCESS_KEY="82MPTDCECMCE52ZT59R5"
  export MINIO_SECRET_KEY="4mw7HNvzBvNjVOAgwPauTYcO39WNHSH8"
  ...
  sleep 3
  # create the bucket
  mc config host add tmp http://${MINIO_ENDPOINT} 82MPTDCECMCE52ZT59R5 4mw7HNvzBvNjVOAgwPauTYcO39WNHSH8
